 ...
 */
export function computeOverlap(celBounds, canvas) {
 ...
 */
export function canvasToCel(canvasPoint, celBounds) {
    return {
 ...
 */
export function celToCanvas(celPoint, celBounds) {
    return {
 ...
 */
export function isInsideCel(canvasPoint, celBounds) {
 ...
 */
export function isInsideCanvas(point, canvas) {
 ...
 */
export function normalizeCelToCanvas(cel, canvas, options) {
 ...
 */
export function expandCelToCanvas(cel, canvas) {
    return {
 ...
 */
export function trimCanvasToCel(canvasBuffer, canvas) {

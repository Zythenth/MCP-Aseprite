 ...
 */
export function measureText(text, font = FONT_3X5) {
    if (text.length === 0)
        return { width: 0, height: font.charHeight };
 ...
 */
export function drawGlyph(dstData, dstWidth, dstHeight, startX, startY, glyph, font, r, g, b, a = 255) {
 ...
 */
export function drawText(dstData, dstWidth, dstHeight, startX, startY, text, font = FONT_3X5, r = 200, g = 200, b = 200, a = 255) {
    let curX = startX;
 ...
 */
export function drawNumber(dstData, dstWidth, dstHeight, startX, startY, num, font = FONT_3X5, r = 200, g = 200, b = 200, a = 255) {
 ...
 */
export function calculateOptimalStep(scale, maxCoord, font = FONT_3X5) {
 ...
 */
export function calculateRulerThickness(scale, _maxCoord = 0, font = FONT_3X5) {
 ...
 */
export function attachCoordinateRulers(scaledImage, spriteWidth, spriteHeight, scale, options = {}) {

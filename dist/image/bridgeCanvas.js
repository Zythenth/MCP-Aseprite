import { BufferSizeMismatchError, ImagePipelineError, InvalidDimensionError, decodePngBase64Sync, encodeRgbaToPngBase64, } from "./png.js";
...
export function decodeBridgeCanvas(payload) {
...
export function bridgeCanvasPngBase64(payload) {
...
export function bridgePreviewPngBase64(payload) {
    const preview = payload.preview ?? payload;
    const hasImage = (typeof preview.pngBase64 === "string" && preview.pngBase64.trim().length > 0) ||
        (typeof preview.rgbaBase64 === "string" && preview.rgbaBase64.trim().length > 0);
    if (!hasImage)
        return undefined;
    return bridgeCanvasPngBase64(preview);
}
//# sourceMappingURL=bridgeCanvas.js.map